...
STAGE_TEMPLATES: dict[str, str] = {
    ...
    "reconnaissance": (
        ...
        "You have access to telegram-mcp, discord-mcp, Gmail MCP, and WebSearch tools for monitoring intelligence channels.\n\n"
        ...
        "Read the CLAUDE.md file first to understand the full pipeline context."
    ),
    "cross_reference": (
    ...
    "osint_analysis": (
        ...
        "4. **Proxy indicator check** — Cross-reference with known proxy indicators:\n"
        "   - Landstuhl/Ramstein medevac activity (US casualty severity)\n"
        "   - Flight tracking anomalies\n"
        "   - Economic/market signals\n"
        "5. **Information gaps** — What key questions remain unanswered?\n"
        "6. **Forecast** — Based on current trajectory, what developments are likely in 24-72 hours?\n\n"
